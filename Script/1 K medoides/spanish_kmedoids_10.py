...
LEY_19_2013_KEYWORDS = {
    ...
    "informacion_institucional_fines_objetivos": ["fines", "objetivos institucionales", "mision", "finalidad"],
    ...
    "informacion_organizativa_responsables_organos": ["responsables", "organos", "direccion", "gerencia", "jefatura"],
    ...
    "normativa_proyectos_en_tramitacion": ["proyecto normativo", "tramitacion", "informacion publica"],
    ...
    "subvenciones_importe": ["importe", "cuantia", "subvencion"],
    ...
    "cuentas_anuales_memoria": ["memoria economica", "cuentas anuales"],
    ...
    "acceso_organo_competente": ["organo competente", "resolver solicitudes"],
